          ...
          {favorites.length > 0 ? (
            favorites.map((univ, index) => (
              ...
              >
                ...
                <Flex alignItems="center">
                  {sortCriteria === "user" && (
                    <Flex mr="5px">
                      <Button colorScheme="blue" onClick={() => handleMove(univ.id, "up")}>
                        Up
                      </Button>
                      <Button
                        colorScheme="orange"
                        ml="5px"
                        onClick={() => handleMove(univ.id, "down")}
                      >
                        Down
                      </Button>
                    </Flex>
                  )}
                  <Button colorScheme="red" onClick={() => handleRemoveFavorite(univ.id)}>
                    Remove
                  </Button>
                </Flex>
              </Flex>
            ...
            <Center>
              <Text fontSize="xl" color="gray.500">
                No favorite universities to display.
              </Text>
            </Center>
          )}
        </VStack>
